...
#another label                      
Label(window, text = "\nHere is your text converted to binary notation. If necessary, use your scrollwheel to read the full text.", bg="white", fg="black", font = "none 12").grid(row = 3, column = 0, sticky = W)
#text box
